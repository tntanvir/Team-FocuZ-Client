...
export default function AllUsers() {
    ...
    // Fetch all users
    useEffect(() => {
        fetch("http://127.0.0.1:8000/auth/alluser/", {
            headers: {
    ...
    const handleDeleteClick = (user) => {
        ...
        fetch(`http://127.0.0.1:8000/auth/alluser/${user.id}/`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${sessionStorage.getItem("access")}`,
...
//                 `http://127.0.0.1:8000/auth/alluser/${user.id}/`,
//                 {
//                     method: "PATCH",
//                     headers: {
//                         "Content-Type": "application/json",
...
//                     };
//                     const res = await fetch(
//                         `http://127.0.0.1:8000/auth/team/${team.id}/update/`,
//                         {
//                             method: "PATCH",
//                             headers: {
//                                 "Content-Type": "application/json",
...
//                     `http://127.0.0.1:8000/auth/team/${selectedTeam.id}/update/`,
//                     {
//                         method: "PATCH",
//                         headers: {
//                             "Content-Type": "application/json",
