...
//                 toast.success('Team Create Successfull', {
//                     position: "top-right",
//                     autoClose: 3000,
...
//                 toast.error('Team Create Failed', {
//                     position: "top-right",
//                     autoClose: 3000,
//                     hideProgressBar: false,
//                     closeOnClick: false,
...
const AddTeamModal = ({ isOpen, onClose, onTeamAdded }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://team-focu-z-backend.vercel.app/team/teams/', {  // Correct URL
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${accessToken}`,
